        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-catelogue">
              <ul class="nav flex-column sub-menu" style="background :#fff !important; color:#4B49AC !important">
                <li class="nav-item"> <a @if(Session::get("page")=="sctions") style="background: #4B49AC !important; color:#fff !important" @else style="background: #4B49AC !important; color:#fff !important"  @endif class="nav-link" href="{{ url('admin/sections') }}">Sections</a></li>
